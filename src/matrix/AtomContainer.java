...
/**
 * XXX : This is just a demo implementation to test out faster ways to store
 * bonds and access the connectivity.
 * 
 *
 */
public class AtomContainer extends ChemObject 
  implements IAtomContainer, IChemObjectListener, Serializable, Cloneable {
	...
	/**
	 * Redundant info about the bonds
	 */
	protected int[][] bondMatrix;
