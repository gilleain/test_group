...
public class PlanarBlockEmbedder {
     ...
     * @return
     */
    public static BlockEmbedding embed(IAtomContainer atomContainer) {
        return embed(new Block(atomContainer), atomContainer);
    }
...
//        cycles = CycleFinder.getSortedConnectedSimpleCycles(cycles);
    ...
    public static BlockEmbedding embedInCycle(
            Block circuit, Block blockToEmbed, IAtomContainer atomContainer) {
        Block currentBlock = circuit;

        // make an embedding of the circuit
        BlockEmbedding embedding = new BlockEmbedding(atomContainer, circuit);
