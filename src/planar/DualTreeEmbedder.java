...
/**
 * A specialized embedder for graphs whose dual is a tree, which implies it has
 * an outerplanar drawing without crossing edges. This applies to most graphs
 * that are composed of a few fused cycles.
 * 
 * @author maclean
 * 
 */
public class DualTreeEmbedder {
    ...
    public static BlockEmbedding embed(IAtomContainer graph) {
        return embed(graph, CycleFinder.getMaxCycle(new Block(graph)));
    }

    public static BlockEmbedding embed(IAtomContainer graph, Block outerCycle) {
