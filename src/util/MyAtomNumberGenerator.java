...
public class MyAtomNumberGenerator implements IGenerator<IAtomContainer> {
   ...
   public static class AtomNumberStartCount extends AbstractGeneratorParameter<Integer> {
       /** {@inheritDoc}} */
   ...
   private IGeneratorParameter<Integer> numberStart = new AtomNumberStartCount();
   ...
   public IRenderingElement generate(IAtomContainer container, RendererModel model) {
       ...
       int number = numberStart.getValue();
